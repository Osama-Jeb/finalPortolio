    ...
    return (
        <section id="about" className="mt-12 mb-12 sm:mt-0 sm:mb-0">
            ...
            <div>
                ...
                <div className="flex text-2xl items-center flex-col sm:flex-row leading-loose ">
                    <div>
                        <p className="text-balance w-[60vw]">
                        ...
                        <div className="sm:hidden block sm:mt-0 mt-10">
                        ...
                        <p className="text-balance w-[60vw] sm:mt-3 mt-10">
