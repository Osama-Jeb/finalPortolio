const Loading = () => {
    ...
    return (
        <>
            <div className='fixed fade w-[99.8vw] h-[100vh] flex items-center justify-center top-0 left-0 bg-[#4a4a4a]'>
...
34 c26 55 398 698 415 718 14 16 46 17 456 15 l440 -3 213 -365z" className="svg-elem-1"></path>
...
-274 185 -30 374 90 424 270 7 25 19 51 28 58 24 19 255 17 275 -4z" className="svg-elem-2"></path>
...
124 -109 317 -15 316 152 0 40 -30 105 -61 133 -42 38 -129 67 -129 43z" className="svg-elem-3"></path>
...
85 6 217 -104 243 -17 4 -28 2 -28 -4z" className="svg-elem-4"></path>
...
-10 0 1 -9 24 -19z" className="svg-elem-5"></path>
                        <path d="M1185 1275 c-32 -31 -34 -86 -5 -115 31 -31 93 -27 119 6 29 37 26
70 -8 105 -36 36 -73 37 -106 4z" className="svg-elem-6"></path>
                    </g>
                </svg>
